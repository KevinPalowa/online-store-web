...
type Props = { src: string | StaticImageData; title: string; children: string };
export default function Card({ src, title, children }: Props) {
  return (
    <div className="w-72 rounded-lg shadow-lg bg-white max-w-sm">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 text-base mb-4 font-bold">Rp.100.000</p>
        <Link
          ...
          href={`https://wa.me/+6283836222168?text=Halo`}
          target="_blank"
        >
          Chat Whatsapp
        </Link>
